...
**Retrieve detailed specifications from milestone-specific knowledge files:**

**For Milestone 1 (Descriptive/Diagnostic)**:
- Reference: `milestone-01-requirements.md`
...
**For Milestone 2 (Predictive - TWO DATASETS)**:
- Reference: `milestone-02-requirements.md`
...
**For Milestone 3 (Prescriptive - TWO PROBLEMS)**:
- Reference: `milestone-03-requirements.md`
...
2. **Generate** data (reference milestone-specific requirements for structure)
...
- Reference milestone-specific knowledge files for detailed requirements:
  - `milestone-01-requirements.md` - Descriptive/Diagnostic
  - `milestone-02-requirements.md` - Predictive (TWO datasets)
  - `milestone-03-requirements.md` - Prescriptive (TWO problems)
